    ...
    def run(self):
        ...
        for i in range(3000):           
            try:
                ...
                testcmd2 = os.system("sudo python3 ./test.py -f query_new/stable_query.py  >>/root/log/testcmd2.txt")                
                print ("The regular_query_union.py num:%d result is %d " % (i ,  testcmd2))
                testcmd3 = os.system("sudo python3 ./test.py -f query_new/stable_query.py  >>/root/log/testcmd3.txt")                
