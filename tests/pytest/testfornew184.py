    ...
    def run(self):
        ...
        for i in range(30):           
            try:
                ...
                testcmd4 = os.system("sudo python3 ./test.py -f query_new/stable_query_null.py  >>/root/log/testcmd4.txt")
                print ("The stable_query_null.py num:%d result is %d " % (i ,  testcmd4))
                testcmd5 = os.system("sudo python3 ./test.py -f query_new/stable_query_union.py  >>/root/log/testcmd5.txt")                
                print ("The stable_query_union.py num:%d result is %d " % (i ,  testcmd5))
                testcmd6 = os.system("sudo python3 ./test.py -f query_new/stable_query.py  >>/root/log/testcmd6.txt")                
                print ("The stable_query.py num:%d result is %d " % (i ,  testcmd6))

                if testcmd1==0 and testcmd2==0 and testcmd3==0:
                    continue
                elif testcmd4==0 and testcmd5==0 and testcmd6==0:
                    continue
                else:
                    break
